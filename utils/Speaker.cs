...
namespace RGame {
    public class Speakers {
        public const string QUEST = Display.MAGENTA + "Zadanie: " + Display.WHITE;
        public const string EQUIPMENT = Display.MAGENTA + "Ekwipunek: " + Display.WHITE;

        public const string ELIOT = Display.BLUE + "Eliot: " + Display.WHITE;
