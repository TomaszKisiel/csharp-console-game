...
namespace RGame {
    public class ItemsRepository {
        ...
        private ItemsRepository() {
            repo.Add( "raspberry_pi_without_sd_card", new Item( "Raspberry Pi", "Miniaturowy komputer wielkości karty kredytowej.. brakuje w nim jedynie karty z systemem operacyjnym.", 59 ) );
            ...
            repo.Add( "raspberry_pi_with_rootkit",  new Item( "Raspberry Pi", "Raspberry Pi zainfekowane rootkit'em.", 81 ) );
